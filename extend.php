...
return [
    ...
    (new Extend\Settings())
        ...
        ->default('nopj-ai.system_prompt', file_get_contents(__DIR__ . '/resources/prompt.txt'))
        ->default('nopj-ai.max_tokens', '1024')
        ->default('nopj-ai.temperature', '0.7')
        ->default('nopj-ai.context_posts_count', '5')
        ->default('nopj-ai.streaming', false)
    ...
    (new Extend\Routes('api'))
        ...
        ->post('/nopj-ai/process-async', 'nopj-ai.process-async', \Nopj\Ai\Api\Controller\ProcessAiAsyncController::class),
];
